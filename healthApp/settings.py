...
SECRET_KEY = 'django-insecure-@^(ny=c%tq4z(xf(c@^afob=*j_b*a%!at$2!_fn)q*kz4tfyp'
...
REST_FRAMEWORK= {
    'DEFAULT_AUTHENTICATION_CLASS': ['oauth2_provider.contrib.rest_framework.OAuth2Authentication']
}
MIDDLEWARE = [
...
MEDIA_ROOT = f'{BASE_DIR}/health/static/'
